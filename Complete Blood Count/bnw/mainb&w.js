...
var optsrbc = {
  ...
  staticZones: [
   {strokeStyle: "black", min: 0, max: 33}, // Yellow
   {strokeStyle: "grey", min: 33, max: 67}, // Green
   {strokeStyle: "black", min: 67, max: 100}, // Yellow
],
  generateGradient: true
};
...
var opts = {
  ...
  staticZones: [
  {strokeStyle: "black", min: 0, max:33 }, // Yellow
  {strokeStyle: "grey", min: 33, max: 66}, // Green
  {strokeStyle: "black", min: 66, max: 100}, // Yellow
  ],
  generateGradient: true
  };
...
var optsplatelets = {
  ...
  strokeColor: 'red',   // to see which ones work best for you
  staticZones: [
   {strokeStyle: "black", min: 0, max: 25}, // Yellow
   {strokeStyle: "grey", min: 25, max: 75}, // Green
   {strokeStyle: "black", min: 75, max: 100}, // Yellow
],
  generateGradient: true
};
...
gauge.set(platelet*100/6);
 ...
 strokeColor: 'red',   // to see which ones work best for you
 staticZones: [
  {strokeStyle: "black", min: 0, max: 26}, // Yellow
  {strokeStyle: "grey", min: 26, max: 73}, // Green
  {strokeStyle: "black", min: 73, max: 100}, // Yellow
],
 generateGradient: true
};
